...
CREATE TABLE `like` (
  ...
  CONSTRAINT `like_ibfk_2` FOREIGN KEY (`comment_id`) REFERENCES `comment` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `like_ibfk_3` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `like_ibfk_4` FOREIGN KEY (`like_status_id`) REFERENCES `like_status` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4;

/*Data for the table `like` */

insert  into `like`(`id`,`date_created`,`like_status_id`,`post_id`,`comment_id`,`user_id`) values 
...
CREATE TABLE `user_channel` (
  ...
  PRIMARY KEY (`id`),
  KEY `user_channel_ibfk_1` (`role_id`),
  KEY `user_channel_ibfk_2` (`user_id`),
  KEY `user_channel_ibfk_3` (`channel_id`),
  CONSTRAINT `user_channel_ibfk_1` FOREIGN KEY (`role_id`) REFERENCES `role` (`id`) ON UPDATE CASCADE,
...
insert  into `user_channel`(`id`,`user_id`,`channel_id`,`role_id`,`date_joined`) values 
(2,1,2,2,'2020-07-13'),
(4,2,2,1,'2020-07-13'),
(5,3,3,2,'2020-07-13');
