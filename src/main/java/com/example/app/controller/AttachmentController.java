...
public class AttachmentController {
    ...
    @PostMapping("/add")
    public AttachmentDto add(@RequestParam MultipartFile file,
    ...
    public ResponseEntity<Resource> addLike(@PathVariable Long parentId,
                                            @PathVariable String fileName,
                                            @PathVariable String parentName) throws IOException {
    ...
    public ResponseEntity<HttpResponse> removeAttachment(@PathVariable Long id,
