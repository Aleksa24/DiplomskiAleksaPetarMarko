...
import com.example.app.constant.AccountActivationConstant;
...
public class EmailServiceImpl implements EmailService {
    ...
    @Autowired
    public EmailServiceImpl(JavaMailSender emailSender, AccountActivationTokenRepository accountActivationTokenRepository) {
    ...
    @Override
    public void sendAccountActivationLinkToUserEmail(UserDto savedUserDto) throws NoSuchAlgorithmException, MessagingException {
